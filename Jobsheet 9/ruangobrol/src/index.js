...
// Emulasi __dirname di ESM
const __filename = fileURLToPath(import.meta.url)
const __dirname = path.dirname(__filename)

// Import bad-words via jalur ESM (hindari require)
import * as BadWords from 'bad-words'
// Tentukan class yang benar (fallback untuk berbagai bentuk ekspor)
const FilterClass = BadWords.default || BadWords.Filter || BadWords
// (nanti saat dipakai kita instansiasi baru)
